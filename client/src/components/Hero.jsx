...
const Hero = () => {
  return (
    ...
    px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat 
    bg-cover bg-center h-screen'>
        <p className='bg-[#4989FF]/50 px-3.5 py-1 rounded-full mt-20'>The Ultime Hotel Experience</p>
        ...
        <p className='msx-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exclusive hotels
